...
from unitybackendapp.api import ScoreAPI, RegisterUser, DeleteUser, GetAuthToken, SavegameAPI, SavegameListAPI
...
urlpatterns = patterns('unitybackendapp.views',
    ...
    url(r'^api/getsavegames', SavegameListAPI.as_view())
